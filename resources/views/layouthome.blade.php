...
<body class="d-flex flex-column min-vh-100">
    ...
    @endif
        <div class="container-fluid col-md-10">
            <a class="navbar-brand {{Request::path() == '/' ? 'text-light' : 'text-dark'}}" href="{{ url('/') }}"><img src="{{asset("storage/DRE_trans_25.png")}}" class="rounded" alt=""></a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
                ...
                <a class="nav-link text-light fw-bold {{Request::path() == '/' ? 'text-light' : 'text-dark'}}" href="{{ Route('aboutUs')}}" style="align-self: center;">
                    About Us
                </a>
